...
using ECommerce_1_ASP_NET_Core.Models;
using ECommerce_1_ASP_NET_Core.Models.ViewModels;
using ECommerce_1_ASP_NET_Core.Utility;
...
namespace ECommerce_1_ASP_NET_Core.Controllers
{
